          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="md:w-1/2 mb-8 md:mb-0 pr-4">
              ...
              <p className="text-gray-700 mb-8">
                We are committed to providing exceptional banking services that
                empower our members and community. Our cooperative approach
            ...
            <div className="md:w-1/2 relative">
              <div className="rounded-full bg-blue-900 h-64 w-64 absolute right-0 top-[-50px] overflow-hidden">
                <img
                  src={student}
                  alt="Woman on phone"
              ...
              <div className="rounded-full bg-red-500 h-48 w-48 absolute left-0 bottom-0 overflow-hidden">
                <img
                  ...
                  className="object-cover pt-3 pl-4"
                />
              </div>
        ...
        <div className="bg-gray-50 rounded-lg shadow-md p-8 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 mb-12 text-center">
            <h2 className="text-4xl font-bold text-blue-900 mb-4">
              Get in Touch with the <span className="underline">Modern</span>{" "}
              Banking
            </h2>
            <p className="max-w-3xl mx-auto text-gray-700">
              Our cooperative approach ensures that our customers are at the
              heart of everything we do, offering personalized solutions to meet
          ...
          <div className="flex flex-col md:flex-row mt-20">
            ...
            <div className="md:w-1/2 relative z-10 mt-8 md:mt-0">
              <div className="rounded-lg shadow-lg bg-white flex justify-center mb-[-34px]">
                <img
                  src={desktop}
              ...
              <div className="flex justify-between space-x-4">
                <div className="bg-white rounded-lg shadow p-4 flex-1">
                  ...
                  <p className="text-xs text-gray-600">
                    Our saving product gives you the ultimate experience of
                    customer-friendly banking service.
                  </p>
                </div>
                <div className="bg-white rounded-lg shadow p-4 flex-1">
                  <h4 className="text-red-500 font-medium mb-1">
                  ...
                  <p className="text-xs text-gray-600">
                    Loan facilities that help you build your life in serious
                    ways.
                  </p>
                </div>
                <div className="bg-white rounded-lg shadow p-4 flex-1">
                  ...
                  <p className="text-xs text-gray-600">
                    Introducing wealth bank fixed deposits with the highest
